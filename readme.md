...
All experiments on the GY-reaching task have data on day No.24 for demonstration.
...
```bash
cd .../your_path/MANA-code
python GY-p2/long-term-decoding/MANA-ANN.py
```

The process of running .py file:

- Dimensionality reduction:
![image-20250626015550438](/Users/hly/Library/Application Support/typora-user-images/image-20250626015550438.png)

- Manifold alignment: (This process may take some time.)
![image-20250626015802675](/Users/hly/Library/Application Support/typora-user-images/image-20250626015802675.png)

- Supervised training and unsupervised adaptation:
![image-20250626015927064](/Users/hly/Library/Application Support/typora-user-images/image-20250626015927064.png)
...
- mix_length  
    ...
    ```bash
    python GY-p2/long-term-decoding/MANA-ANN.py --mix_length XXX
    ```
...
```bash
cd .../your_path/MANA-code
python GY-p2/long-term-decoding/MANA-SNN.py
```
...
![image-20250626022444848](/Users/hly/Library/Application Support/typora-user-images/image-20250626022444848.png)
