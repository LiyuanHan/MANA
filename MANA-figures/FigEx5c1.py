...
with open('./data/FigEx5c1.pkl', 'rb') as f:
...
plt.title('DvsGesture')
plt.xticks(labels)
plt.ylim(20, 100)
plt.yticks(range(30, 110, 10))

plt.legend(plot_list, ["MLP", "GRU", "Transformer", "MANA (ANN)", "MANA (SNN)"], loc='lower right', bbox_to_anchor=(1, 0))
...
path__savefig = 'figs/FigEx5c1.pdf'
