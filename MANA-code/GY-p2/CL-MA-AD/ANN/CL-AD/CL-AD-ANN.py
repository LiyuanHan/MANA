...
path__project = "./GY-p2/CL-MA-AD/ANN/CL-AD"
...
# path_subpath__modelName = f'/ANN_(cv2-relu-avg2)_(lin512-relu)_(mixlen_{mix_length})_(lr_1e-2_1e-3)'
path_subpath__modelName = f'/pureKD3A_crossday_mix-{mix_length}'
...
check_paths = [path__save_acc, path__save_loss, path__save_linout, path__save_model]
