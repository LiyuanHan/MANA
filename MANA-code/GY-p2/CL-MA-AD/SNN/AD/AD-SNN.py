...
path__project = "./GY-p2/CL-MA-AD/SNN/AD"
...
path_subpath__modelName = f'/KD3AwoCL_SNN_crossday_mix-{mix_length}'
    ...
    for test_count in range(len(test_Day_list)):
        ...
        for turn in range(5):
            ...
            if configs["DataConfig"]["dataset"] == "DomainNet":
                ...
                today = '20240312-v2-p2-crossday_h1-64_h2-3072_turn_' + str(turn) # v1, v2
