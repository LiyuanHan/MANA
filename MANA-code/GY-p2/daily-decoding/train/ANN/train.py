...
def train(train_dloader_list, model_list, classifier_list, optimizer_list, classifier_optimizer_list, epoch, num_classes, model_savepath, turn, testDay, domain_weight, source_domains, batchnorm_mmd, batch_per_epoch, confidence_gate_begin, confidence_gate_end, communication_rounds, total_epochs, malicious_domain, attack_level, mix_aug=True, regularization_weight=0):
    ...
    for i, (image_t, label_t) in enumerate(train_dloader_list[0]):
        ...
        # print(f"consensus_focus_dict-1 = {consensus_focus_dict}")
        ...
        # print(f"consensus_focus_dict-2 = {consensus_focus_dict}")
    ...
    # print(f"target_weight={target_weight}, source_domain_num={source_domain_num}")
    target_weight = round(target_parameter_alpha / (source_domain_num + 1), 4)
    # print(f"target_weight-3= {target_weight}")
    # print(f'target_weight[0] = {target_weight[0]}, target_weight[1] = {target_weight[1]}, target_parameter_alpha = {target_parameter_alpha}, target_weight = {target_weight}')
    epoch_domain_weight = []
