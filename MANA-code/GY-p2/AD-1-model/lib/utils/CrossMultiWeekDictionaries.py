...
def valid_range_for_cross_week_num(cross_week_num, train_weeks=4):
    if train_weeks == 4:
        if cross_week_num == 0:
        ...
        if cross_week_num == 1:
            cross_week_num = int(cross_week_num) # 1
            start_day = first_days_of_week[cross_week_num + 1] # 3
            end_day = 119
            return list(range(start_day, end_day + 1))
        ...
        if cross_week_num == 1:
            cross_week_num = int(cross_week_num) # 1
            start_day = first_days_of_week[cross_week_num + 2] # 3
            end_day = 119
            return list(range(start_day, end_day + 1))
        ...
        if cross_week_num == 1:
            cross_week_num = int(cross_week_num) # 1
            start_day = first_days_of_week[cross_week_num + 3] # 3
            end_day = 119
            return list(range(start_day, end_day + 1))
        ...
        if cross_week_num == 1:
            cross_week_num = int(cross_week_num) # 1
            start_day = first_days_of_week[cross_week_num + 5] # 3
            end_day = 119
            return list(range(start_day, end_day + 1))
            

def generate_domain_dict_and_day_from_to_dict(cross_week_num=1, train_weeks=4, method="average", domain_num=None): # 根据跨周数，生成域长度字典和起止字典
    domain_dict = dict()
    day_from_to_dict = dict()
    if method == "average":
        if domain_num is not None:
            raise ValueError("When method is 'average', domain_num should be None.")
        if train_weeks == 4:
            if cross_week_num == 0:
                # train first 4 weeks
            ...
            if cross_week_num == 1:
                cross_week_num = int(cross_week_num)
                for day in valid_range_for_cross_week_num(cross_week_num, train_weeks): # [3, ..., 119]
                    # cross multi weeks
                    # day = 3
                    week_num = find_week_number_for_day(day) #   3
                    train_start_week_num = week_num - cross_week_num #      
                    ...
                    day_from_to_dict[str(day)] = [
                        first_days_of_week[train_start_week_num ], #    1
                        first_days_of_week[train_start_week_num + 1] - 1, #     2
                    ]
        elif train_weeks == 2:
            if cross_week_num == 1:
                cross_week_num = int(cross_week_num)
                for day in valid_range_for_cross_week_num(cross_week_num, train_weeks): # [3, ..., 119]
                    ...
                    # day = 3
                    week_num = find_week_number_for_day(day) #   3
                    train_start_week_num = week_num - cross_week_num - 1 #      
                    ...
                    day_from_to_dict[str(day)] = [
                        first_days_of_week[train_start_week_num ], #    1
                        first_days_of_week[train_start_week_num + 2] - 1, #     2
                    ]
        elif train_weeks == 3:
            if cross_week_num == 1:
                cross_week_num = int(cross_week_num)
                for day in valid_range_for_cross_week_num(cross_week_num, train_weeks): # [3, ..., 119]
                    ...
                    # day = 3
                    week_num = find_week_number_for_day(day) #   3
                    train_start_week_num = week_num - cross_week_num - 2 #      
                    ...
                    day_from_to_dict[str(day)] = [
                        first_days_of_week[train_start_week_num ], #    1
                        first_days_of_week[train_start_week_num + 3] - 1, #     2
                    ]
        elif train_weeks == 5:
            if cross_week_num == 1:
                cross_week_num = int(cross_week_num)
                for day in valid_range_for_cross_week_num(cross_week_num, train_weeks): # [3, ..., 119]
                    ...
                    # day = 3
                    week_num = find_week_number_for_day(day) #   3
                    train_start_week_num = week_num - cross_week_num - 4 #      
                    ...
                    day_from_to_dict[str(day)] = [
                        first_days_of_week[train_start_week_num ], #    1
                        first_days_of_week[train_start_week_num + 5] - 1, #     2
                    ]
        ...
        if cross_week_num == 0:
            ...
            cross_week_num = int(cross_week_num)
            for day in valid_range_for_cross_week_num(cross_week_num, train_weeks):
                # cross multi weeks
                week_num = find_week_number_for_day(day)
                train_start_week_num = week_num - cross_week_num - (train_weeks - 1)
                domain_dict[str(day)] = [
                    first_days_of_week[train_start_week_num + wk + 1] - first_days_of_week[train_start_week_num + wk] for wk in range(train_weeks)
                ]
                day_from_to_dict[str(day)] = [
                    first_days_of_week[train_start_week_num], 
                    first_days_of_week[train_start_week_num + train_weeks] - 1,
                ]

        if domain_num == 1:
            for key in domain_dict.keys():
                domain_dict[key] = [sum(domain_dict[key])]
        elif domain_num == 4 or domain_num is None:
            pass
        else:
            raise ValueError("When method is 'domains', domain_num should be 1 or None (4).")
...
def verify_day_in_test_range(day, cross_week_num, train_weeks=4):
    valid_day_list = valid_range_for_cross_week_num(cross_week_num, train_weeks)
