...
def get_domainnet_dloader_test(base_path, domain_data, domain_label, batch_size, num_workers, mix_length, output_data=False):
    ...
    if output_data:
        return (train_data, train_label), (domain_data, domain_label)
