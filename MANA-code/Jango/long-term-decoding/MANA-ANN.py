...
import argparse
from model.MANAANN_Jango.domainnet import DomainNet_encoder, DomainNetClassifier
from train.train_ANN_Jango import *
...
path__save_w_hs = base_path + save_weight_hidden_state__rel_path + f"/{name__model_type}"
    ...
    for test_count in range(len(test_Day_list)):
        ...
        for turn in range(len(seed_set)):
            ...
            for epoch in range(args.start_epoch, total_epochs):
                ...
                test_acc_list.append([r2_avg, r2_x, r2_y, seeds])
